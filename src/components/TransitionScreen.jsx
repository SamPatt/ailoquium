...
const TransitionScreen = () => {
    const { timer, moneyAtStartOfLevel, moneyRemainingFromCurrentJob, proceedToNextPatient, lastPatientMessage, numOfAITreated, username, totalTime, setTotalTime, setGameWon } = useContext(GameContext);
